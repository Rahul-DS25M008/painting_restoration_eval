...
| 33 Final Evaluation Report | Prepared | Not started | Pending | 32 upstream manifests; 33 current input tables; 300 paintings; 3,425 registered cases; 2,620 evaluated cases; 10,480 four-method primary candidates; 13,879 approved report candidates; 1,025 uncertainty groups; 15 tables/338 rows; 24 figures; 49 claims; 18 limitations | Preserve all 32 pilot output paths and eight artifact roles; add HINT to every applicable table, figure and narrative; treat `core_three_model` only as a retained upstream identifier whose Controlled-300 rows contain four full methods; do not mark complete until the manual run, pilot comparison and final gate pass |

Notebooks 01–32, including Notebook 12A and supplemental D02, are completed
Controlled-300 producers. Notebook 33 has a validated preparation layer and is
the next active producer awaiting manual rerun; Notebooks 33–36 remain historical Controlled-50
