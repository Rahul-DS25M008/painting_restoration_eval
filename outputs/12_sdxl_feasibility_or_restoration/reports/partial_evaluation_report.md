...
The notebook predeclared 35 balanced cases across 30
paintings, used one generic prompt and seed 2026, and enforced a
25,200-second global budget plus a 900-second per-case
watchdog. This is a purposive partial evaluation, not a full SDXL branch.

## Execution result

- Scheduled rows: 35
- Technically valid completed rows: 24
- Status counts: `{'completed': 24, 'skipped': 10, 'timed_out': 1}`
- Runtime: 4788.5 seconds total; median 198.0 seconds
...
The independent unit is the painting (n=30). Repeated cases from
